...
for i in range(65, 91):
    ...
    c += 1
REV_CLASS_MAP[87-65]='Water'
REV_CLASS_MAP[66-65]='Hai'
REV_CLASS_MAP[90-65]='Hai'
REV_CLASS_MAP[65-65]='Hai'
REV_CLASS_MAP[83-65]='Thankyou'
REV_CLASS_MAP[89-65]='Thankyou'
REV_CLASS_MAP[68-65]='Eat'
REV_CLASS_MAP[74-65]='Wash room'
REV_CLASS_MAP[79-65]='NO'
REV_CLASS_MAP[71-65]='Pet'
REV_CLASS_MAP[80-65]='Pet'
REV_CLASS_MAP[81-65]='NO'
REV_CLASS_MAP[86-65]='Yes'
REV_CLASS_MAP[78-65]='Yes'
...
while True:
    ...
    cv2.putText(frame, "Text Message: " + text_msg,
                (750, 50), font, 1.2, (255, 0, 0), 2, cv2.LINE_AA)
   # if text_msg.strip().lower()!='none':
       # speak_engine.say(text_msg)
...
def onclick(self):
    ...
    self.speech_engine.say(text_msg) 
...
bt1 = Button(root, text='Click here to translate!', command=onclick, fg='green', bg='red')
 #callback
